      ...
      <div class="row">
        ...
        <form action="" method="POST">
          <div class="form-floating mb-3">
            <input type="number" class="form-control" id="floatingInput" placeholder="Cód. Cliente:" name="cod" value="<?php echo $vetor['cod'] ?>" readonly>
            <label for="floatingInput">Código Cliente</label>
          </div>
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" placeholder="Nome do Cliente:" name="nome" value="<?php  echo $vetor['nome'] ?>" readonly>
            <label for="floatingInput">Nome do Cliente</label>
          </div>
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" placeholder="Agência do Cliente:" name="agencia" value="<?php echo $vetor['agencia'] ?>" readonly>
            <label for="floatingInput">Agência do Cliente</label>
          </div>
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" placeholder="C/C" name="conta" value="<?php echo $vetor['conta'] ?>" readonly>
            <label for="floatingInput">Conta Corrente</label>
          </div>
          <div class="form-floating mb-3">
            <input type="password" class="form-control" id="floatingInput" placeholder="Senha do Cliente:" name="senha" value="<?php echo $vetor['senha'] ?>" readonly>
            <label for="floatingInput">Senha do Cliente</label>
          </div>
          <div class="form-floating mb-3">
            <input type="number" class="form-control" id="floatingInput" placeholder="R$ SALDO:" name="saldo" value="<?php echo  $vetor['saldo'] ?>" readonly>
          ...
          <?php
            if(isset($_POST['excluir'])){
              $sql="DELETE FROM banco WHERE cod='$cod'";
              $dados=mysqli_query($chave,$sql);
